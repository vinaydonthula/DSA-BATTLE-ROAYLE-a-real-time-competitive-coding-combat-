...
CREATE TABLE `admins` (
  ...
  `role` enum('problem_setter','admin','superadmin') DEFAULT 'admin',
...
INSERT INTO `admins` VALUES (1,'admin1@gmail.com','$2b$10$oxD3uLtw7tP0O1MDxv0DDeIwEmf/XXWkqSUYRqolU2zIttiMfMPRi','superadmin','2026-01-12 05:01:06');
...
-- Dump completed on 2026-02-19 17:47:54
